...
api_key = "AIzaSyDoR9Dh1MBNfX7KPoh382DYzuTGC57An0A"
...
def get_channel_details(channel_id):
    ...
    for i in range(len(response['items'])):
        data = dict(Channel_id=channel_id[i],
                    ...
                    Playlist_id=
                    response['items'][i]['contentDetails']['relatedPlaylists'][
                        'uploads'],
...
def get_channel_videos(channel_id):
    ...
    playlist_id = res['items'][0]['contentDetails']['relatedPlaylists'][
        'uploads']
        ...
        for video in response['items']:
            video_details = dict(Channel_name=video['snippet']['channelTitle'],
                                 ...
                                 Comments=video['statistics'].get(
                                     'commentCount'),
                                 Favorite_count=video['statistics'][
                                     'favoriteCount'],
                                 Definition=video['contentDetails'][
                                     'definition'],
                                 Caption_status=video['contentDetails'][
                                     'caption']
                                 )
